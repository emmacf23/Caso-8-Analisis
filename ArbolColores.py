...
colores = [negro,azulOscuro,azul,verdeOscuro,turquesaOscuro,azulClaro,verde,verdeClaro,celeste,vino,morado,purpura]
colores = colores + [gris,lila,lima,limaClaro,celesteClaro,rojo,fucsia,rosado,naranja,paloRosa,pink,amarillo,amarilloClaro,blanco]
...
def buscarColor(nodo, color):
    return find_by_attr(nodo, name="rgb", value=color.rgb).name
